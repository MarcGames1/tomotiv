    ...
    <>
      <div className="prose m-auto bg-base-100 p-10 prose-xl">
        ...
        <ol>
          ...
          <li>Datele tale sunt stocate în siguranţă într-un mediu securizat</li>
          <li>
        ...
        <p>
          ...
          soluționarea problemelor, asigurarea serviciilor și prevenirea fraudei
          și abuzurilor;
        </p>
        <p>
        ...
        <p>
          Trimiterea mesajelor și informațiilor administrative, inclusiv mesaje
          de la traineri și facilitatori, notificări despre modificările aduse
          serviciilor noastre și actualizări ale acordurilor noastre;
        </p>
        <p>
          ...
          promoții, mesaje informative și alte cursuri disponibile (mesaje de la
          care vă puteţi dezabona în orice moment);
        </p>
        <p>
        ...
        <p>
          ...
          private a vizitatorilor care accesează unul dintre site-urile{' '}
          {dateLegale.site} (denumit în continuare “ {brand} ”), în conformitate
          cu Regulamentul (UE) 2016/679 al Parlamentului European și al
          Consiliului din data de 27 aprilie 2016 privind protecția persoanelor
          fizice în ceea ce privește prelucrarea datelor cu caracter personal și
          libera circulație a acestor date (denumit în continuare “GDPR”).
        </p>
        <p>
        ...
        <p>
          DPP explică practicile {brand}, referitoare la aplicarea prevederilor
          GDPR, precum și drepturile de care beneficiați cu privire la modul în
          care informațiile dumneavoastră sunt utilizate prin intermediul
          aplicaţiilor {brand}.
        </p>
        <p>
          ...
          reglementările privind protecția datelor cu caracter personal,
        ...
        <h2>CE SUNT DATELE CU CARACTER PERSONAL?</h2>
        <p>
        ...
        <p>
          ...
          numele și prenumele, sexul, data și locul nașterii, datele din actele
          de stare civilă, telefon/fax, adresă (domiciliu/reședință), e-mail,
          profesie, loc de muncă, formare profesionala, situație familială,
          situație economico-financiară, date privind bunurile deținute,
          obișnuinte/preferințe/comportament, imagine, voce, preferințele
          personale și obiceiurile de cumpărături, conținutul generat de
          utilizatori, informațiile financiare și informațiile privind situația
          financiară.
        </p>
        <p>
          Acesta ar putea include și identificatori numerici unici, cum ar fi
          adresa IP a computerului dumneavoastră sau adresa MAC a dispozitivului
          dumneavoastră mobil, precum și modulele cookie.
        </p>
        <h2>CE ÎNSEAMNĂ PRELUCRAREA DATELOR CU CARACTER PERSONAL?</h2>
        <p>
          ...
          sau punerea la dispoziție în orice alt mod, alinierea sau combinarea,
          restricționarea, ștergerea sau distrugerea.
        </p>
        <h2>PRINCIPII PRIVIND PRELUCRAREA DATELOR</h2>
        <p>
          {brand}, se obligă să respecte principiile de protecție a datelor cu
          caracter personal (denumite în continuare „Principiile”) prevăzute de
          GDPR, pentru a se asigura că toate datele sunt:
        </p>
        <ol>
        ...
        <ol>
          ...
          <li>
            Locația, inclusiv locația geografică în timp real a computerului sau
            a dispozitivului dvs. prin GPS și adresa dvs. IP, împreună cu
            locațiile Wi-Fi hotspot și gsm, dacă utilizați funcții bazate pe
            locație și activați Serviciile de localizare setări pe dispozitiv și
            pe computer.
          </li>
        </ol>
        <p>
          ...
          aplicabile privind protecția datelor. Vom procesa astfel de date numai
          dacă v-ați dat consimțământul explicit sau este necesar (de exemplu,
          dacă solicitați asistență specială) sau ați făcut public aceste date
          în mod deliberat.
        </p>
        <h2>CE DATE NU STOCĂM NICIODATĂ</h2>
        <p>
          Datele cardului de plată al Clientului/ Utilizatorului/ Cumparătorului
          nu vor fi accesibile și nici nu vor fi stocate de către {brand}, ci
          doar de către instituția de autorizare a Tranzacției sau o altă
          entitate autorizată să presteze servicii de stocare date de
          identificare a cardului, despre a cărei entitate Clientul/
          Utilizatorul/ Cumpărătorul va fi informat, anterior introducerii
          datelor.
        </p>
        <p>
          3D Secure înseamna o nouă abordare globală a autentificarii
          cumpărătorilor și vânzărilor în tranzacții sigure pe Internet. Această
          măsură de siguranță presupune redirecționarea utilizatorului în
          momentul efectuarii plații pe o pagină securizată, unde înregistrarea
          fiecărui deținător de card se face prin atribuirea unui cod de
          autorizare pentru fiecare tranzacție online. Cardurile acceptate la
          plată sunt cele emise sub siglele VISA (Classic și Electron) și
          MASTERCARD (inclusiv Maestro, dacă au cod CVV/CV2).
        </p>
        <h2>
        ...
        <ol>
          ...
          <li>
            Pentru a vă contacta în cazul unei schimbări a orarului sau anulări:
            vă trimitem informații în legătură cu serviciile pe care le-ați
            solicitat și orice modificări ale acestor servicii. Informațiile nu
            au scop comercial și nu vă puteți dezabona de la ele;
          </li>
          <li>
          ...
          <li>
            ...
            consimțământul dvs. prealabil și depunând toate eforturile pentru a
            vă asigura că toate datele pe care se bazează sunt corecte. Prin
            furnizarea oricăror date personale sunteți de acord în mod explicit
            că putem să-l folosim, pentru a realiza activități de profilare în
          ...
          <li>
            Pentru a furniza servicii personalizate: folosim datele dvs. pentru
            a furniza informații care credem că vă interesează înainte, în
            timpul și după participarea dvs. și pentru a personaliza serviciile
          ...
          <li>
            ...
            abona sau dezabona de la astfel de comunicări, indicând acest lucru
            în etapa de rezervare. De asemenea, la orice comunicare online din
            partea noastră sau a partenerilor noștri de încredere, veți avea
            ocazia să indicați că nu mai doriți să primiți materialele noastre
            de marketing direct.
          </li>
        </ol>
        <p>
          ...
          pentru care am colectat și pentru care trebuie să folosim datele dvs.
          personale.
        </p>
        <p>
        ...
        <p>
          ...
          perioada de păstrare adecvată, luăm în considerare cantitatea, natura
          și sensibilitatea datelor personale, scopurile pentru care le
          prelucrăm și dacă putem atinge aceste scopuri prin alte mijloace.
        </p>
        <p>
          De asemenea, trebuie să luăm în considerare perioadele pentru care ar
          putea fi necesar să păstrăm date cu caracter personal pentru a ne
        ...
        <p>
          Atunci când nu mai avem nevoie de datele dvs. personale, le vom șterge
          sau distruge în siguranță. De asemenea, vom lua în considerare dacă și
          cum putem minimiza în timp cantitatea de date personale pe care le
          folosim și dacă putem asigura anonimitatea datelor dvs. Personale,
          astfel încât acestea să nu mai fie asociate cu dvs. sau să vă
          identifice, caz în care putem folosi acele informații fără a vă
          notifica ulterior.
        </p>
        ...
        <p>
          ...
          indicate anterior. Păstrăm datele dumneavoastră numai pentru perioada
          necesară pentru atingerea scopului, pentru care deținem datele, pentru
          a satisface nevoile dumneavoastră sau pentru a ne îndeplini
        ...
        <ol>
          ...
          <li>
            ...
            personale până când solicitați să le ștergem sau după o perioadă de
            inactivitate (fără o interacțiune activă cu mărcile noastre)
            definite în conformitate cu reglementările și îndrumările locale. În
            acest sens, menționăm că datele prelucrate pentru acest scop vor fi
            șterse la 5 ani după ultima interacțiune cu utilizatorul contului
            (ca de exemplu, login în contul dumneavoastră);
          </li>
          <li>
            ...
            solicitați să le ștergem sau după o perioadă de inactivitate (fără o
            interacțiune activă cu mărcile noastre), definite în conformitate cu
            reglementările și îndrumările locale. În acest sens, menționăm că
            datele stocate în bazele noastre de date pentru scopul comunicărilor
            de marketing direct sunt șterse din evidențele acestor baze de date
            la 5 ani de la ultima interacțiune cu dumneavoastră;
          </li>
          <li>
            În cazul în care modulele cookie sunt stocate pe computer, le
            păstrăm atâta timp cât este necesar pentru ca acestea să își atingă
            scopurile (de exemplu, pe durata unei sesiuni pentru cookie-urile de
            coș de cumpărături sau cookie-urile pentru ID-uri de sesiune) și
            pentru o perioadă definită în conformitate cu reglementările și
            îndrumările locale. În acest sens, menționăm că datele prelucrate
            prin modulele cookies folosite pentru a furniza publicitate
            comportamentală online, pentru a ne personaliza serviciile pentru
            dumneavoastră și pentru a permite distribuirea conținutului nostru
            pe site-uri de socializare (butoane de distribuire destinate
            afișării site-ului), vor fi păstrate pentru o perioadă de maxim 5
            ani de la colectarea acestora, în baza consimțământului
            dumneavoastră.
          </li>
        </ol>
        <h2>SECURITATEA PRELUCRĂRII</h2>
        <p>
          ...
          acțiuni de acces neautorizat, utilizare necorespunzătoare sau
          transmitere, modificare neautorizată, distrugere sau pierdere
          accidentală. Toți angajații și colaboratorii {brand}, precum și orice
          terțe părți care acționează în numele și pe seama {brand} sunt
          obligați să respecte confidențialitatea informațiilor dumneavoastră și
          cerințele GDPR, în conformitate cu prevederile prezentei Politici.
        </p>
        ...
        <p>
          Toate detaliile de înscriere sunt transmise printr-o conexiune de tip
          SSL cu ajutorul infrastructurii de rețea dedicate (Multiprotocol Label
        ...
        <p>
          ...
          încredere în scopurile stabilite în această Politică de
        ...
        <h2>PROCESAREA FORMULARELOR DE CONTACT SAU ÎNSCRIERE</h2>
        <p>
        ...
        <p>
          ...
          posibil ca, în anumite circumstanțe, să avem obligația de a transmite
          datele dumneavoastră, partenerilor cu care {brand} colaborează și/sau
          altor terți furnizori de servicii ai {brand} .
        </p>
        <p>
          ...
          prelucrarea în conformitate cu cerințele GDPR a datelor dumneavoastră,
          de către entitățile menționate anterior.
        </p>
        <p>
        ...
        <p>
          ...
          site-ului {brand} vor putea fi transferate către terți doar în
          situația în care există consimțământul dumneavoastră expres pentru a
          proceda în acest sens, cu excepția situațiilor în care există o
          obligație legală pentru {brand} de a proceda în acest mod.
        </p>
        <p>
          Site-ul {brand} poate conține, la un moment dat, link-uri de acces
          către alte site-uri ale căror politici de prelucrare a datelor pot fi
          diferite de cele ale {brand}.
        </p>
        <p>
        ...
        <p>
          ...
          absolute de a oferi informații la un nivel mai înalt, atât global, cât
          și intern sau extern, partenerilor noștri și celor cu care facem
          transfer de date cu respectarea Regulamentului mai sus amintit, în
          virtutea asigurării oferirii unor servicii cât mai profesionale cu
          putință. Informațiile controlate de {brand} ar putea fi transferate,
          transmise sau stocate și prelucrate în UE sau în alte țări decât țara
          în care locuiți, în scopurile descrise în această politică. Aceste
          transferuri de date sunt necesare pentru a putea furniza servicii la
          cel mai înalt nivel, precum și a continua să vă furnizăm materialele
          noastre la cel mai bun nivel profesional. Utilizăm clauze contractuale
          standard aprobate de Comisia Europeană și ne bazăm pe deciziile
          privind caracterul adecvat emise de Comisia Europeană, cu privire la
          anumite țări, după caz, în ceea ce privește transferurile de date din
          SEE către Statele Unite și către alte țări.
        </p>
        <h2>PRELUCRARE AUTOMATĂ DE DATE. COOKIE</h2>
        <p>
          Site-ul {brand} folosește identificatori de tip Cookie. În acest sens
          puteți consulta mai jos Politica noastră de Cookie și vă puteți
        ...
        <ol>
          ...
          <li>
            ...
            învechite și/sau să le completați dacă acestea sunt incomplete. Dacă
            aveți un cont, poate fi mai ușor să vă corectați propriile date prin
            intermediul funcției „Contul meu” sau prin email la
            {dateFirma.email}
          </li>
          <li>
            <b> Dreptul la ștergerea datelor (“dreptul de a fi uitat”)</b> – În
            unele cazuri, aveți dreptul de a obține ștergerea sau distrugerea
            Datelor dumneavoastră. Acesta nu este un drept absolut, deoarece
            uneori s-ar putea să fim forțați să păstrăm Datele dumneavoastră din
            motive legale sau juridice.
          </li>
          <li>
            ...
            astfel încât să putem păstra Datele, dar să nu le utilizăm sau să le
            procesăm. Acest drept se aplică în circumstanțe specifice prevăzute
            de Regulamentul general privind protecția datelor, și anume:
          </li>
        </ol>
        <p>
        ...
        <p>
          ...
          operatorului ( {brand} ) depășesc pe cele ale persoanei vizate (adică
          dumneavoastră).
        </p>
        <ol>
          <li>
            ...
            noastră de date într-o alta. Acest lucru se aplică numai datelor pe
            care le-ați furnizat, atunci când procesarea se bazează pe
          ...
          <li>
            ...
            datelor dumneavoastră atunci când o astfel de prelucrare se bazează
            pe un interes legitim.
          </li>
          <li>
          ...
          <li>
            ...
            reședință sau de domiciliu pentru a contesta practicile de protecție
            a datelor oferite de {brand} .
          </li>
          <li>
            Dreptul de a vă opune prelucrării datelor dumneavoastră în scopuri
            de marketing direct – Vă puteți dezabona sau renunța la comunicarea
            noastră de marketing direct în orice moment. Este mai ușor să faceți
            acest lucru dând clic pe linkul „dezabonare” în orice e-mail sau
            comunicare pe care vi le trimitem.
          </li>
          <li>
            Dreptul de a vă opune prelucrării datelor dumneavoastră de către noi
            atunci când desfășurăm acțiuni în interes public sau în interesele
            legitime proprii sau ale unui terț – Vă puteți opune în orice moment
            prelucrării datelor dumneavoastră atunci când o astfel de prelucrare
            se bazează pe un interes legitim.
          </li>
          <li>
            Dreptul de a dezactiva Cookies– aveți dreptul să dezactivați
            modulele cookie. Setările din browser-ele de Internet sunt de obicei
            programate în mod implicit pentru a accepta modulele cookie, dar
            puteți să le reglați ușor modificând setările browser ului.
          </li>
        </ol>
        <p>
          ţi poţi exercita aceste drepturi, fie individual, fie cumulat, foarte
          uşor, prin simpla transmitere a unei solicitări la sediul nostru din{' '}
          {dateFirma.sediuSocial}, sau prin E-mail, la: {dateFirma.email}
        </p>
        <h2>SOLICITĂRI JURIDICE</h2>
        <p>
        ...
        <ol>
          <li>
            ...
            asemenea, este posibil să răspundem la solicitări de natură juridică
            atunci când considerăm, cu bună-credință, că răspunsul impus de
            legile din jurisdicția respectivă afectează utilizatorii din acea
            jurisdicție și este conform cu standardele recunoscute la nivel
            internațional.
          </li>
          <li>
            ...
            de reglementare sau pentru a preveni decesul sau vătămarea corporală
            iminentă. De exemplu, dacă este relevant, furnizăm informații către
            și primim informații de la terți parteneri despre fiabilitatea
            contului dumneavoastră, pentru a preveni frauda, abuzul și alte
            activități dăunătoare în cadrul și în afara materialelor noastre.
          </li>
        </ol>
        <p>
          ...
          solicitări de natură juridică sau unei obligații legale, al unei
          anchete guvernamentale, sau al unor investigații privind posibile
          încălcări ale condițiilor sau politicilor noastre, sau în alte cazuri
          pentru a preveni prejudiciile.
        </p>
        <h2>EXONERARE DE RĂSPUNDERE</h2>
        <p>
          Site-ul {site} poate conține legături către alte site-uri și/sau alte
          pagini web care nu sunt proprietatea {brand} . {brand} nu își asumă
          nicio responsabilitate cu privire la conținutul acestor site-uri și,
          prin urmare, nu va putea fi ținută răspunzătoare pentru conținutul,
          publicitatea, bunurile, serviciile, software-ul, informațiile sau alte
          materiale disponibile pe sau prin intermediul acestor site-uri.
          ...
          vizitatorilor sau de alte daune morale și/ sau patrimoniale cauzate de
          accesul la respectivele site-uri.
        </p>
        <h2>
        ...
        <h2>CONTACT</h2>
        <p>
          Dacă aveți întrebări sau preocupări cu privire la modul în care tratăm
          și folosim datele dumneavoastră cu caracter personal, sau doriți să vă
          exercitați oricare dintre drepturile dumneavoastră, vă rugăm să ne
          contactați la {dateFirma.email}
        </p>
      </div>
    </>
  );
