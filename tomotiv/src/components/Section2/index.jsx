  ...
  return (
    ...
    <section>
      ...
      <div
        id="cardWrapper"
        className={tw(
          'flex lg:flex-row w-10/12 flex-col gap-5 lg:w-4/6 content-center items-center m-auto'
          )}
          >
        <Card
          icon={<BsFillPencilFill size={'2em'} color={colors.accent} />}
          header={'Înveți SEO DE LA ZERO'}
          content={
            'Indiferent de nivelul tău în SEO, îți sunt explicate de la zero toate informațiie de care ai nevoie.'
          }
          />
        <Card
          icon={<BsFillPencilFill size={'2em'} color={colors.accent} />}
